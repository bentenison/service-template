...
var httpStatus = map[ErrCode]int{
	...
	Canceled:           http.StatusGatewayTimeout,      //504
	...
	PermissionDenied:   http.StatusForbidden,           //403
	ResourceExhausted:  http.StatusTooManyRequests,     //429
	FailedPrecondition: http.StatusBadRequest,          //400
